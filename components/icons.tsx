type IconProps = { name: "home" | "search" | "plus" | "grid" | "help" | "bell" | "user" | "comment" | "vote" | "arrow" | "chevron" | "send"; size?: number };
...
export function Icon({ name, size = 20 }: IconProps) {
  const paths = {
    ...
    help: <><circle cx="12" cy="12" r="9"/><path d="M9.8 9a2.3 2.3 0 1 1 3.2 2.1c-.7.3-1 .8-1 1.6v.3"/><path d="M12 17h.01"/></>,
