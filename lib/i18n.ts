...
const ja: Dictionary = {
  ...
  "category.AI & Work": "AI", "category.AI & Tech": "AI", "category.World Cup": "ワールドカップ", "category.Immigration": "移民", "category.Cost of Living": "生活費", "category.Society": "社会", "category.Politics": "政治", "category.Work & Business": "仕事・ビジネス", "category.Money": "お金", "category.Relationships": "人間関係", "category.Technology": "テクノロジー", "category.Entertainment": "エンタメ", "category.Sports": "スポーツ", "category.Education": "教育", "category.Lifestyle": "ライフスタイル"
};
...
const fr: Dictionary = {
  ...
  "category.AI & Work": "IA", "category.AI & Tech": "IA", "category.World Cup": "Coupe du monde", "category.Immigration": "Immigration", "category.Cost of Living": "Coût de la vie", "category.Society": "Société", "category.Politics": "Politique", "category.Work & Business": "Travail et affaires", "category.Money": "Argent", "category.Relationships": "Relations", "category.Technology": "Technologie", "category.Entertainment": "Divertissement", "category.Sports": "Sports", "category.Education": "Éducation", "category.Lifestyle": "Mode de vie"
};
...
const ko: Dictionary = {
  ...
  "category.AI & Work": "AI", "category.AI & Tech": "AI", "category.World Cup": "월드컵", "category.Immigration": "이민", "category.Cost of Living": "생활비", "category.Society": "사회", "category.Politics": "정치", "category.Work & Business": "업무·비즈니스", "category.Money": "금융", "category.Relationships": "관계", "category.Technology": "기술", "category.Entertainment": "엔터테인먼트", "category.Sports": "스포츠", "category.Education": "교육", "category.Lifestyle": "라이프스타일"
};
