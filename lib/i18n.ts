...
const en = {
  ...
  "action.report": "Report", "action.reported": "Reported", "action.delete": "Delete", "action.reply": "Reply", "action.translate": "Translate", "action.original": "Show original", "action.post": "Post", "action.cancel": "Cancel", "action.save": "Save changes", "action.skip": "Skip",
  "sort.best": "Best", "sort.new": "New", "sort.old": "Old",
  "thread.back": "← Back to debates", "thread.started": "Started {time} ago", "thread.votePrompt": "Where do you stand?", "thread.agree": "Agree", "thread.disagree": "Disagree", "thread.previewVote": "Your vote has been saved.", "thread.comments": "{count} comments", "thread.discussion": "DISCUSSION", "thread.now": "now", "thread.noVote": "no vote", "thread.points": "{count} points", "thread.write": "Write a comment...", "thread.composerNote": "Saved with your Guest ID · No URLs", "thread.translationSoon": "Translation will be available soon.", "thread.replying": "Replying to #{number}",
...
const ja: Dictionary = {
  ...
  "action.report": "報告", "action.reported": "報告済み", "action.delete": "削除", "action.reply": "返信", "action.translate": "翻訳", "action.original": "原文を表示", "action.post": "投稿", "action.cancel": "キャンセル", "action.save": "変更を保存", "action.skip": "スキップ",
  "sort.best": "ベスト", "sort.new": "新着", "sort.old": "古い順",
  "thread.back": "← 議論一覧へ", "thread.started": "{time}前に開始", "thread.votePrompt": "あなたの意見は？", "thread.agree": "賛成", "thread.disagree": "反対", "thread.previewVote": "投票を保存しました。", "thread.comments": "コメント {count}件", "thread.discussion": "ディスカッション", "thread.now": "たった今", "thread.noVote": "未投票", "thread.points": "{count}ポイント", "thread.write": "コメントを書く...", "thread.composerNote": "ゲストIDで保存 · URL不可", "thread.translationSoon": "翻訳機能は近日公開予定です。", "thread.replying": "#{number} に返信中",
  ...
  "category.Society": "社会", "category.Politics": "政治", "category.Work & Business": "仕事・ビジネス", "category.Money": "お金", "category.Relationships": "人間関係", "category.Technology": "テクノロジー", "category.Entertainment": "エンタメ", "category.Sports": "スポーツ", "category.Education": "教育", "category.Lifestyle": "ライフスタイル"
};

const es: Dictionary = {
  "language.label": "Idioma", "nav.home": "Inicio", "nav.search": "Buscar", "nav.create": "Crear", "nav.categories": "Categorías", "nav.guest": "Invitado",
  "action.report": "Reportar", "action.reported": "Reportado", "action.delete": "Eliminar", "action.reply": "Responder", "action.translate": "Traducir", "action.original": "Ver original", "action.post": "Publicar", "action.cancel": "Cancelar", "action.save": "Guardar cambios", "action.skip": "Omitir",
  "sort.best": "Mejores", "sort.new": "Nuevos", "sort.old": "Antiguos",
  "thread.back": "← Volver a debates", "thread.started": "Iniciado hace {time}", "thread.votePrompt": "¿Qué opinas?", "thread.agree": "De acuerdo", "thread.disagree": "En desacuerdo", "thread.previewVote": "Tu voto ha sido guardado.", "thread.comments": "{count} comentarios", "thread.discussion": "DEBATE", "thread.now": "ahora", "thread.noVote": "sin voto", "thread.points": "{count} puntos", "thread.write": "Escribe un comentario...", "thread.composerNote": "Guardado con tu ID de invitado · Sin URL", "thread.translationSoon": "La traducción estará disponible pronto.", "thread.replying": "Respondiendo a #{number}",
...
const pt: Dictionary = {
  ...
  "action.report": "Denunciar", "action.reported": "Denunciado", "action.delete": "Excluir", "action.reply": "Responder", "action.translate": "Traduzir", "action.original": "Ver original", "action.post": "Publicar", "action.cancel": "Cancelar", "action.save": "Salvar alterações", "action.skip": "Pular",
  "sort.best": "Melhores", "sort.new": "Novos", "sort.old": "Antigos",
  "thread.back": "← Voltar aos debates", "thread.started": "Iniciado há {time}", "thread.votePrompt": "Qual é a sua opinião?", "thread.agree": "Concordo", "thread.disagree": "Discordo", "thread.previewVote": "Seu voto foi salvo.", "thread.comments": "{count} comentários", "thread.discussion": "DISCUSSÃO", "thread.now": "agora", "thread.noVote": "sem voto", "thread.points": "{count} pontos", "thread.write": "Escreva um comentário...", "thread.composerNote": "Salvo com seu ID de visitante · Sem URLs", "thread.translationSoon": "A tradução estará disponível em breve.", "thread.replying": "Respondendo a #{number}",
...
const ko: Dictionary = {
  ...
  "category.Society": "사회", "category.Politics": "정치", "category.Work & Business": "업무·비즈니스", "category.Money": "금융", "category.Relationships": "관계", "category.Technology": "기술", "category.Entertainment": "엔터테인먼트", "category.Sports": "스포츠", "category.Education": "교육", "category.Lifestyle": "라이프스타일"
};
